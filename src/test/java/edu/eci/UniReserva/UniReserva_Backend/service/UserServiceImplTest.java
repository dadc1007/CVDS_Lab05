...
class UserServiceImplTest {
  ...
  void setUp() {
    ...
    updateName =
        new User("1037126548", "Alejandro", "email@gmail.com", "Password#123", Role.PROFESOR);
  ...
  public void shouldUpdateName() {
    ...
    ApiResponse<UserDto> response =
        userServiceImpl.updateUser(
            validUser.getId(), new User(null, "Alejandro", null, null, Role.PROFESOR));

    assertNotNull(response);
    assertNotNull(response.getData());
    UserDto result = response.getData();
    assertNotNull(result);
    verify(userRepository).save(argThat(user -> user.getName().equals("Alejandro")));
  }
  ...
  public void shouldUpdatePassword() {
    ...
    ApiResponse<UserDto> response =
        userServiceImpl.updateUser(
            validUser.getId(), new User(null, null, null, "NewPassword#123", Role.PROFESOR));
    ...
    Exception exception =
        assertThrows(
            ...
            () ->
                userServiceImpl.updateUser(
                    validUser.getId(),
                    new User(null, null, null, "weakpass", Role.PROFESOR)));
  ...
  public void shouldNotUpdateEmail() {
    ...
    Exception exception =
        assertThrows(
            ...
            () ->
                userServiceImpl.updateUser(
                    validUser.getId(), new User(null, null, "newEmail@gmail.com", null, Role.PROFESOR)));
  ...
  void shouldGetUserWhenUserExists() {
    ...
    assertEquals(Role.PROFESOR, result.getRol());
  }
  ...
  void shouldNotGetUserWhenUserDoesNotExist() {
    ...
    Exception exception = assertThrows(IllegalArgumentException.class, () -> userServiceImpl.getUser(userId));
